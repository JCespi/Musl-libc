...
{	
	...
	*/
	...
	__asm_syscall(R0_OPERAND, "r"(r1), "r"(r2));
}
...
{	
	...
	*/
	...
	__asm_syscall(R0_OPERAND, "r"(r1), "r"(r2), "r"(r3));
}
...
static inline long __syscall4(long n, long a, long b, long c, long d)
{
	...
	*/
	...
	__asm_syscall(R0_OPERAND, "r"(r1), "r"(r2), "r"(r3), "r"(r4));	
}
...
static inline long __syscall5(long n, long a, long b, long c, long d, long e)
{
	...
	*/
	...
	__asm_syscall(R0_OPERAND, "r"(r1), "r"(r2), "r"(r3), "r"(r4), "r"(r5));	
}
...
static inline long __syscall6(long n, long a, long b, long c, long d, long e, long f)
{
	...
	*/
	...
	__asm_syscall(R0_OPERAND, "r"(r1), "r"(r2), "r"(r3), "r"(r4), "r"(r5), "r"(r6));	
}
